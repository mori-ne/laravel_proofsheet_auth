      ...
      <div class="flex min-h-screen flex-row items-stretch">
         ...
         <main class="h-svh flex-1 overflow-y-scroll">
            ...
            <div class="mx-auto max-w-5xl p-6">
               ...
               {{-- title --}}
               <div class="mb-8">
                  <h4 class="text-lg font-bold">フォーム管理</h4>
                     ...
                     @foreach ($forms as $form)
                        <div class="mb-3 flex flex-col rounded-md border border-gray-300 bg-white px-8 py-4">
                           ...
                           <div class="mb-2 flex items-center justify-start gap-2 border-b border-gray-300 pb-2">
                              ...
                              {{-- input method --}}
                              <div class="ml-auto">
                                 <a href="{{ route('forms.inputEdit', $form->id) }}" target="_blank" class="rounded border border-gray-300 px-3 py-1 text-xs">入力項目エディターを開く</a>
