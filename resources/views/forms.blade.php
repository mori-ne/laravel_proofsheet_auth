                    ...
                    <div>
                        <form action="{{ route('forms.search') }}" method="GET" class="flex gap-2">
                            ...
                            <input name="search" type="text" placeholder="フォームを検索" value="{{ request('search') }}"
                                class="ring-offset-background flex h-10 w-80 rounded border border-neutral-200 bg-white px-3 py-2 text-sm placeholder:text-neutral-500 focus:border-neutral-200 focus:outline-none focus:ring-2 focus:ring-neutral-400 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" />
                            {{-- button --}}
                            <button type="submit"
                                class="focus:shadow-outline inline-flex items-center justify-center rounded border border-neutral-200 bg-white px-4 py-2 text-sm font-medium tracking-wide text-neutral-500 transition-colors duration-200 hover:bg-neutral-100 hover:text-neutral-700 focus:bg-white focus:outline-none focus:ring-2 focus:ring-neutral-200/60 focus:ring-offset-2 active:bg-white">
                                検索
                            </button>
                        </form>
                    </div>
                ...
                <div class="mb-8">
                    ...
                    <div>
                        @foreach ($forms as $form)
                            <div class="mb-3 flex flex-col rounded border border-neutral-200 bg-white px-8 py-4">
                                ...
                                <div class="mb-2 flex items-center justify-start gap-2 border-b border-neutral-200 pb-2">
                                    ...
                                    <div x-data="{
                                        ...
                                        <button @click="dropdownOpen=true"
                                            class="inline-flex h-6 items-center justify-center rounded bg-white px-2 text-sm font-medium transition-colors hover:bg-neutral-100 focus:bg-white focus:outline-none focus:ring-2 focus:ring-neutral-200/60 focus:ring-offset-2 active:bg-white disabled:pointer-events-none disabled:opacity-50"><i
