            ...
            <div class="mx-auto max-w-5xl p-6">
               ...
               <div x-data="{
                  ...
                  <div x-ref="tabButtons"
                     class="relative mb-8 inline-grid h-12 w-full select-none grid-cols-4 items-center justify-center rounded-lg border border-gray-300 bg-white p-1 text-gray-500">
                              ...
                              @foreach ($project->forms as $form)
                                 <div class="mb-3 flex flex-col rounded-md border border-gray-300 bg-white px-8 py-4">
                                    ...
                                    <div class="mb-2 flex items-center justify-start gap-2 border-b border-gray-300 pb-2">
                                       ...
                                       {{-- input method --}}
                                       <div class="ml-auto">
                                          <a href="{{ route('forms.inputEdit', $form->id) }}" target="_blank" class="rounded border border-gray-300 px-3 py-1 text-xs"
                                       ...
                                       <div x-data="{
                                          ...
                                          <button @click="dropdownOpen=true"
                                             class="inline-flex h-6 items-center justify-center rounded-md bg-white px-2 text-sm font-medium transition-colors hover:bg-neutral-100 focus:bg-white focus:outline-none focus:ring-2 focus:ring-neutral-200/60 focus:ring-offset-2 active:bg-white disabled:pointer-events-none disabled:opacity-50"><i
                                                class="at-dots-vertical"></i></button>
                                          <div x-show="dropdownOpen" @click.away="dropdownOpen=false" x-transition:enter="ease-out duration-200" x-transition:enter-start="-translate-y-2"
                                             x-transition:enter-end="translate-y-0" class="absolute left-1/2 top-0 z-50 mt-10 w-48 -translate-x-1/2" x-cloak>
                                             <div class="rounded-md border border-neutral-200/70 bg-white p-1 text-sm text-neutral-700 shadow-md">
