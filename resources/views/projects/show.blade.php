                                ...
                                <div class="mb-8">
                                    ...
                                    <div class="mb-3 flex justify-end">
                                        <a href="{{ route('forms.create', 'project=' . $project->id) }}"
                                            class="focus:shadow-outline inline-flex items-center justify-center rounded bg-neutral-600 px-4 py-2 text-sm font-medium tracking-wide text-white transition-colors duration-200 hover:bg-neutral-900 focus:outline-none focus:ring-2 focus:ring-neutral-900 focus:ring-offset-2">
                                            フォームを新規作成
                                        </a>
                                    </div>
                                    ...
                                    <div>
                                        @foreach ($project->forms as $form)
                                            <div class="mb-4 flex rounded p-4 transition-all hover:bg-neutral-100">
                                                <div class="flex flex-col rounded border-0">
                                                ...
                                                <div x-data="{
                                                    ...
                                                    <button @click="dropdownOpen=true"
                                                        class="inline-flex h-6 items-center justify-center rounded bg-white px-2 text-sm font-medium transition-colors hover:bg-neutral-200 focus:bg-white focus:outline-none focus:ring-2 focus:ring-neutral-200/60 focus:ring-offset-2 active:bg-white disabled:pointer-events-none disabled:opacity-50"><i
                                                            class="at-dots-vertical"></i></button>
                                                    <div x-show="dropdownOpen" @click.away="dropdownOpen=false" x-transition:enter="ease-out duration-200" x-transition:enter-start="-translate-y-2" x-transition:enter-end="translate-y-0"
                                                        class="z-100 absolute left-1/2 top-0 mt-10 w-48 -translate-x-1/2" x-cloak>
