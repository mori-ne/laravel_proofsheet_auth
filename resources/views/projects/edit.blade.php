                    ...
                    <div class="px-4 pt-6">
                        <div class="mb-6 flex flex-row items-center gap-2">
                            ...
                            <div class="mr-4">
                                ...
                                <select name="status" class="roundedd ml-4 rounded border border-neutral-200">
                                    @if ($project->status)
                            ...
                            <div class="mr-4">
                                ...
                                <input name="is_deadline" class="roundedd ml-4 rounded border border-neutral-200" type="datetime-local" value="{{ old('is_deadline', $project->is_deadline) }}">
                            </div>
