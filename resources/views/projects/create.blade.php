            ...
            <div class="mb-3 rounded-sm border-0 bg-white p-8 shadow-md shadow-neutral-200">
                ...
                <form action="{{ route('projects.confirm') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input name="project_name" type="text" placeholder="プロジェクト名を記入してください" value="{{ old('project_name') }}" class="text-md ring-offset-background flex h-10 w-full rounded-sm border-0 bg-neutral-100 px-3 py-2 placeholder:text-neutral-500" />
                        @error('project_name')
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="projectinstance" name="project_description" type="text" placeholder="プロジェクトの概要を記入してください" class="flex h-48 min-h-[80px] w-full rounded-sm border-0 bg-neutral-100 px-3 py-2 text-sm placeholder:text-neutral-400">{{ old('project_description') }}</textarea>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="project_message" id="projectinstance" type="text" placeholder="プロジェクトの説明を記入してください" class="flex h-48 min-h-[80px] w-full rounded-sm border-0 bg-neutral-100 px-3 py-2 text-sm placeholder:text-neutral-400">{{ old('project_message') }}</textarea>
                    ...
                    <div class="mb-6">
                        ...
                        <input name="mail_subject" type="text" placeholder="メールの件名を記入してください" value="{{ old('mail_subject', '「●●●●●●●●●●●●●●●●●●●●」演題登録 投稿受付通知') }}" class="text-md ring-offset-background flex h-10 w-full rounded-sm border-0 bg-neutral-100 px-3 py-2 placeholder:text-neutral-500" />
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="projectinstance" name="mail_content" type="text" placeholder="メールの返信内容を記入してください" class="flex h-48 min-h-[80px] w-full rounded-sm border-0 bg-neutral-100 px-3 py-2 text-sm placeholder:text-neutral-400">{!! old(
                            'mail_content',
