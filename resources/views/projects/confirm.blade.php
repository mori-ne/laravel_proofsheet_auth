...
@section('content')
    <main class="h-svh flex-1 overflow-y-scroll">
        ...
        <div class="mx-auto max-w-5xl p-6">
            ...
            <div class="mb-8">
                <h4 class="text-lg font-bold">プロジェクト確認画面</h4>
            ...
            <div class="mb-3 rounded-md border border-gray-300 bg-white p-8">
                ...
                <div class="mt-8">
                    <p class="mb-4 text-center text-sm text-gray-500">この内容で新規登録します。よろしいですか？</p>
                    ...
                    <form action="{{ route('projects.store') }}" method="POST">
                        ...
                        <button type="submit"
                            class="focus:shadow-outline mx-auto flex w-96 items-center justify-center rounded-md bg-neutral-950 px-4 py-2 text-sm font-medium tracking-wide text-white transition-colors duration-200 hover:bg-neutral-900 focus:outline-none focus:ring-2 focus:ring-neutral-900 focus:ring-offset-2">
                            新規作成する
                        </button>
                </div>
                </form>
