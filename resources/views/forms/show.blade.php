        ...
        <div class="mx-auto max-w-5xl p-6">
            ...
            <div class="mb-8">
                    ...
                    <div class="ml-auto">
                        <div x-data="{
                            ...
                            <button @click="dropdownOpen=true"
                                class="inline-flex items-center justify-center rounded-sm px-4 py-2 text-lg font-medium transition-colors hover:bg-neutral-100 focus:rounded focus:bg-white focus:outline-none focus:ring-2 focus:ring-neutral-200/60 focus:ring-offset-2 active:bg-white disabled:pointer-events-none disabled:opacity-50"><i
                ...
                <div>
                    ...
                    @else
                        <div class="w-full rounded-sm bg-neutral-200 p-6 text-sm text-neutral-600">{!! $form->form_description !!}</div>
                    @endif
                </div>
