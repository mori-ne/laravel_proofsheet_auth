    ...
    <div class="mx-auto max-w-2xl py-10">
        ...
        <div class="rounded border-0 bg-white p-10 shadow-md shadow-neutral-200">
            ...
            <form action="{{ route('postuser.verifymailsignup', $uuid) }}" method="POST">
                ...
                <button type='submit' class='mx-auto flex w-64 items-center justify-center rounded bg-neutral-800 px-4 py-2.5 text-sm font-bold text-white focus:bg-neutral-600 focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:ring-offset-2 active:bg-neutral-900'>認証メールを再送信
                </button>
            </form>
        </div>
    </div>
