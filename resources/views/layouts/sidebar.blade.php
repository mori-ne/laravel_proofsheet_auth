<aside class="flex flex-col shrink-0 bg-white p-6 w-64 border-neutral-300 border-r h-svh overflow-y-scroll">
    ...
    {{-- account --}}
    <nav x-data="{ open: false }" class="bg-white border-neutral-300 mt-auto">
        <!-- Primary Navigation Menu -->
        <div class="flex justify-start h-16">
            <!-- Settings Dropdown -->
            <div class="w-full hidden sm:flex sm:items-center">
