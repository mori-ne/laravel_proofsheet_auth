        ...
        <main class="flex flex-col">
            ...
            @if (session('status'))
                <div x-data="{ show: true }" x-init="setTimeout(() => show = false, 3000)">
                    <div class="fixed left-0 top-0 z-50 w-full border-b border-green-200 bg-green-100 px-4 py-5 text-green-600" x-show="show" x-transition:leave="transform ease-in duration-1000" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 -translate-y-10"
