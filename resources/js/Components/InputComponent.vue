...
const addField = () => {
   // 既存フィールドの最大IDを計算
   const maxId =
      inputFields.value.length > 0
         ? Math.max(...inputFields.value.map((field) => field.id))
         : -1;
...
<template>
   <div class="relative min-h-screen w-full bg-gray-100">
      <div class="mx-auto flex max-w-7xl flex-col p-8">
         ...
         <div
            class="mx-auto mb-14 flex w-full flex-row overflow-hidden rounded-lg border border-gray-300 bg-white"
         >
            <!-- セット項目 -->
            <div class="w-80 flex-shrink-0 border-r border-gray-300 bg-white">
               <!-- title -->
               <div class="border-b border-gray-300 bg-white p-4 text-gray-500">
               ...
               <ul>
                  ...
                  >
                     <div
                        class="flex flex-row items-center justify-between gap-2 bg-white p-4"
                     >
                        <!-- input field title -->
                        <div class="w-full">
                           <div
                           ...
                           >
                              <p>テキスト（1行）</p>
                              <span
                                 class="ml-auto w-4 text-center text-xs text-gray-300"
                                 >{{ inputField.id }}</span
                              >
                           </div>
                           <div
            ...
            <!-- preview -->
            <div class="mx-auto w-full flex-1 bg-white">
               <!-- title -->
               <div class="border-b border-gray-300 bg-white p-4 text-gray-500">
            ...
            <div
               v-if="debugFlg"
               class="w-80 break-all border-l border-gray-300 p-4"
               style="font-size: 9px"
            >
